...
class NavigateActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new NavigateFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavigateFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NavigateActionFeedback(null);
    ...
    data.feedback = NavigateFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigateActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = NavigateFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new NavigateFeedback()
    }
...
module.exports = NavigateActionFeedback;
