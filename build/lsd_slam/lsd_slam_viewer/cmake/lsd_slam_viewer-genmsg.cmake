...
set(MSG_I_FLAGS "-Ilsd_slam_viewer:/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg")
...
get_filename_component(_filename "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeGraphMsg.msg" NAME_WE)
add_custom_target(_lsd_slam_viewer_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lsd_slam_viewer" "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeGraphMsg.msg" ""
)

get_filename_component(_filename "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeMsg.msg" NAME_WE)
add_custom_target(_lsd_slam_viewer_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lsd_slam_viewer" "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeMsg.msg" ""
)
...
### Generating Messages
_generate_msg_eus(lsd_slam_viewer
  "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeGraphMsg.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/lsd_slam_viewer
)
_generate_msg_eus(lsd_slam_viewer
  "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeMsg.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_eus(lsd_slam_viewer
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/lsd_slam_viewer
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(lsd_slam_viewer_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(lsd_slam_viewer_generate_messages lsd_slam_viewer_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeGraphMsg.msg" NAME_WE)
add_dependencies(lsd_slam_viewer_generate_messages_eus _lsd_slam_viewer_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeMsg.msg" NAME_WE)
add_dependencies(lsd_slam_viewer_generate_messages_eus _lsd_slam_viewer_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(lsd_slam_viewer_geneus)
add_dependencies(lsd_slam_viewer_geneus lsd_slam_viewer_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS lsd_slam_viewer_generate_messages_eus)
...
### Generating Messages
_generate_msg_nodejs(lsd_slam_viewer
  "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeGraphMsg.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/lsd_slam_viewer
)
_generate_msg_nodejs(lsd_slam_viewer
  "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeMsg.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_nodejs(lsd_slam_viewer
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/lsd_slam_viewer
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(lsd_slam_viewer_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(lsd_slam_viewer_generate_messages lsd_slam_viewer_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeGraphMsg.msg" NAME_WE)
add_dependencies(lsd_slam_viewer_generate_messages_nodejs _lsd_slam_viewer_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/hadi/catkin_ws/src/lsd_slam/lsd_slam_viewer/msg/keyframeMsg.msg" NAME_WE)
add_dependencies(lsd_slam_viewer_generate_messages_nodejs _lsd_slam_viewer_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(lsd_slam_viewer_gennodejs)
add_dependencies(lsd_slam_viewer_gennodejs lsd_slam_viewer_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS lsd_slam_viewer_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/lsd_slam_viewer)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/lsd_slam_viewer
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/lsd_slam_viewer)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/lsd_slam_viewer
